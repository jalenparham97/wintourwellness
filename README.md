...
- A native and customizable authoring environment, accessible on `yourpersonalwebsite.com/admin`
...
Your personal website should be up and running on [http://localhost:3000][localhost-3000]! You can create and edit content on [http://localhost:3000/admin][localhost-3000-admin].
